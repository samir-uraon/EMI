...
const deleteSalesman = async (id) => {
  if (!confirm("Delete this salesman and all his loans?")) return;
...
<button
		...
		className="flex items-center gap-2 bg-white shadow hover:bg-gray-200 px-3 py-2 rounded-lg"
>
		<span>👤</span>
		...
		>
				...
				<div className="flex flex-col items-center">
						...
						{/* Logout */}
						<button
								onClick={() => {deleteSalesman(salesmenid)}}
